...
@section('body')
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <form class="validation-form" method="post" action="{{route('xl-them-moi-mau-sac-admin')}}" enctype="multipart/form-data">
                    @csrf
                                ...
                                <div class="card-body card-article">
                                    <div class="form-group title">
                                        ...
                                        <input type="text" class="form-control for-seo text-sm" name="tenmau"
                                            id="fullname" placeholder="Tên màu" @error('tenmau') is-invalid @enderror>
                                        @error('tenmau') <div class="invalid-feedback">{{ $message }}</div>@enderror
                                    </div>
                                    <div class="form-group">
                                        <label class="d-block" for="color">Mã màu:</label>
                                        <input type="color" class="form-control text-sm" name="mamau" id="color" maxlength="7" value="#000000">
                                    </div>
                                </div>
                            </div>
                        </div>
