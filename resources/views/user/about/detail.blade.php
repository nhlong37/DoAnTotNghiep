...
@section('body')
    <div class="wap_detail_news">
        ...
        <div class="title-main"><span>Giới thiệu về chúng tôi</span></div>
        ...
        <div class="content-main autoHeight w-clear" id="toc-content">
            <p>HL Shoe là một website bán giày chuyên nghiệp, uy tín, được nhiều khách hàng tin tưởng lựa chọn. Website cung cấp đa dạng các loại giày 
            ...
            giúp khách hàng có thể tham khảo và đưa ra quyết định mua hàng chính xác. HL Shoe cam kết mang đến cho khách hàng những sản phẩm chất lượng, chính hãng với giá cả hợp lý. Website cũng có chính sách đổi trả hàng trong vòng 7 ngày nếu sản phẩm không đúng mẫu mã, kích cỡ, hoặc có lỗi do nhà sản xuất.</p>
            <p class="mb-0">Dưới đây là một số ưu điểm nổi bật của website HL Shoe:</p>
            <ul>
