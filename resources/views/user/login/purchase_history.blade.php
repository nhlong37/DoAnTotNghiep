            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div class="card-cancle {{ ($item->status == 'moidat') ? 'd-block' : 'd-none' }}">
                    <form>
                        ...
                        <button type="submit" id="{{$item->code}}" onclick="huydonhang(this.id)"
                ...
                <table class="table card-table table-hover mb-0">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="align-middle text-center">
                                <a class="text-dark text-break"
                                    href="{{ route('chi-tiet-product', ['id'=> $order->id_product]) }}" title="">{{
                            ...
                            <td class="align-middle text-center">
                                <span class="text-dark text-break" href="" title="">{{ $c->name }}</span>
                            </td>
                            @endif
                            @endforeach
                            ...
                            <td class="align-middle text-center">
                                <span class="text-dark text-break" href="" title="">{{ $s->name }}</span>
                            </td>
                            @endif
                            @endforeach
